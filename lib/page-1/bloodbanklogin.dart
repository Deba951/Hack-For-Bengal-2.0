...
class BloodBankDonerLoginScreen extends StatefulWidget {
  @override
  State<BloodBankDonerLoginScreen> createState() =>
      _BloodBankLoginScreenState();
}

class _BloodBankLoginScreenState extends State<BloodBankDonerLoginScreen> {
