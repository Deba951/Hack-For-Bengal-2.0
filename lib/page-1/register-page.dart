          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'REGISTER HERE TO BECOME ONE                  OF THE BOON FOR SOCIETY !!!',
                  style: SafeGoogleFont (
                    'Lemon',
                    fontSize: 20*ffem,
                    fontWeight: FontWeight.w400,
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: TextButton(
                                  onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (_)=>MyRegister(),),);},
                                  child: Text(
                                    'DONER',
                                    style: SafeGoogleFont (
                                      'Montserrat',
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 0*fem),
                                child: TextButton(
                                  onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (_)=>BloodSignup(),),);},
                                  child: Text(
                                    'BLOOD BANK',
                                    style: SafeGoogleFont (
                                      'Montserrat',
